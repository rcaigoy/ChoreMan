...
namespace ChoreMan.Entities
{
    ...
    public partial class ChoremanEntities1 : DbContext
    {
        public ChoremanEntities1()
            : base("name=ChoremanEntities1")
        {
        }
        ...
        public virtual DbSet<AppCall> AppCalls { get; set; }
        public virtual DbSet<AppCallType> AppCallTypes { get; set; }
